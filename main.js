...
const ELECTRONWALLET_VERSION = app.getVersion() || '0.3.x';
...
const DEFAULT_SETTINGS = {
    ...
    pubnodes_custom: ['127.0.0.1:35223'],
...
const WIN_TITLE = `${config.appName} ${ELECTRONWALLET_VERSION} - ${config.appDescription}`;
...
log.info(`Starting Electron Wallet ${ELECTRONWALLET_VERSION}`);
...
function initSettings() {
    ...
    settings.set('version', ELECTRONWALLET_VERSION);
    serviceBinCheck();
