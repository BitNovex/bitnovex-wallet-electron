...
const ElectronWalletSession = require('./ws_session');
const ElectronWalletApi = require('./ws_api');
...
const wsession = new ElectronWalletSession(sessConfig);
...
var ElectronWalletManager = function () {
    if (!(this instanceof ElectronWalletManager)) {
        return new ElectronWalletManager();
    }
...
ElectronWalletManager.prototype.init = function () {
    this._getSettings();
    ...
    this.serviceApi = new ElectronWalletApi(cfg);
};

ElectronWalletManager.prototype._getSettings = function () {
    let nodeAddress = settings.get('node_address').split(':');
    this.daemonHost = nodeAddress[0] || null;
    this.daemonPort = nodeAddress[1] || null;
    this.serviceBin = settings.get('service_bin');
...
ElectronWalletManager.prototype._reinitSession = function () {
    this._wipeConfig();
    wsession.reset();
    this.notifyUpdate({
        type: 'sectionChanged',
...
ElectronWalletManager.prototype._serviceBinExists = function () {
    wsutil.isFileExist(this.serviceBin);
};

// check
ElectronWalletManager.prototype.serviceStatus = function () {
    return (undefined !== this.serviceProcess && null !== this.serviceProcess);
};

ElectronWalletManager.prototype.isRunning = function () {
    this.init();
...
ElectronWalletManager.prototype._writeIniConfig = function (cfg) {
...
ElectronWalletManager.prototype._writeConfig = function (cfg) {
    let configFile = wsession.get('walletConfig');
    if (!configFile) return '';
...
ElectronWalletManager.prototype._wipeConfig = function () {
    try { fs.unlinkSync(wsession.get('walletConfig')); } catch (e) { }
};

ElectronWalletManager.prototype.startService = function (walletFile, password, onError, onSuccess, onDelay) {
    this.init();
...
ElectronWalletManager.prototype._argsToIni = function (args) {
    let configData = "";
...
ElectronWalletManager.prototype._spawnService = function (walletFile, password, onError, onSuccess, onDelay) {
    this.init();
...
ElectronWalletManager.prototype.stopService = function () {
...
ElectronWalletManager.prototype.terminateService = function (force) {
...
ElectronWalletManager.prototype.startSyncWorker = function () {
    this.init();
    let wsm = this;
...
ElectronWalletManager.prototype.stopSyncWorker = function () {
...
ElectronWalletManager.prototype.getNodeFee = function () {
    let wsm = this;
...
ElectronWalletManager.prototype.genIntegratedAddress = function (paymentId, address) {
    let wsm = this;
...
ElectronWalletManager.prototype.createWallet = function (walletFile, password) {
    this.init();
    let wsm = this;
    return new Promise((resolve, reject) => {
...
ElectronWalletManager.prototype.importFromKeys = function (walletFile, password, viewKey, spendKey, scanHeight) {
    this.init();
    let wsm = this;
    return new Promise((resolve, reject) => {
...
ElectronWalletManager.prototype.importFromSeed = function (walletFile, password, mnemonicSeed, scanHeight) {
    this.init();
    let wsm = this;
    return new Promise((resolve, reject) => {
        scanHeight = scanHeight || 0;
...
ElectronWalletManager.prototype.getSecretKeys = function (address) {
    let wsm = this;
    return new Promise((resolve, reject) => {
...
ElectronWalletManager.prototype.sendTransaction = function (params) {
    let wsm = this;
    return new Promise((resolve, reject) => {
...
ElectronWalletManager.prototype.rescanWallet = function (scanHeight) {
    let wsm = this;
...
ElectronWalletManager.prototype._fusionGetMinThreshold = function (threshold, minThreshold, maxFusionReadyCount, counter) {
    let wsm = this;
    return new Promise((resolve, reject) => {
        counter = counter || 0;
...
ElectronWalletManager.prototype._fusionSendTx = function (threshold, counter) {
    let wsm = this;
...
ElectronWalletManager.prototype.optimizeWallet = function () {
    let wsm = this;
...
ElectronWalletManager.prototype.networkStateUpdate = function (state) {
    ...
    if (state === 0) {
        ...
        this.init();
        // looks like BitNovex-service always stalled after disconnected, just kill & relaunch it
...
ElectronWalletManager.prototype.notifyUpdate = function (msg) {
    uiupdater.updateUiState(msg);
};

ElectronWalletManager.prototype.resetState = function () {
    return this._reinitSession();
};

module.exports = ElectronWalletManager;
